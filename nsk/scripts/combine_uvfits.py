...
args = argparse.ArgumentParser(description="combine multiple uvfits files")
args.add_argument("files", type=str, nargs='*', help="space-separated files or glob-parsable search string to concatenate into a single uvfits")
