...
# PSA-128: updated by Carina
A_ = [ 64, 10, 49,  3, 41, 25, 19, 48, 29, 24, 28, 55, 34, 27, 51, 57]
B_ = [ 65,  9, 66, 58, 67,  1, 47,  4, 68, 17, 69, 13, 70, 56, 71, 59]
C_ = [ 72, 22, 73, 61, 74, 35, 75, 18, 76,  5, 77, 32, 78, 30, 79, 23]
D_ = [ 80, 20, 81, 63, 82, 42, 83, 37, 84, 40, 85, 14, 86, 54, 87, 50]
E_ = [ 88, 43, 89,  2, 90, 33, 91,  6, 92, 52, 93,  7, 94, 12, 95, 38]
F_ = [ 96, 53, 97, 21, 98, 15, 99, 16,100, 62,101, 44,102,  0,103, 26] 
G_ = [104, 31,105, 45,106,  8,107, 11,108, 36,109, 60,110, 39,111, 46]
ANTPOS = n.array([A_,B_,C_,D_,E_,F_,G_])
