...
for f in ${ARGS}; do
    ...
    if ((${f:33:7} < 2456679 )); then
        ...
        # Firstcal
        ~/capo/omni/omni_apply.py -p ${POL} --firstcal --fcfile ${FIRSTCAL_S1E1} --ba ${BADANTS_S1E1} ${f}
        # Omni Run
        ~/capo/omni/omni_run.py -p ${POL} -C psa6622_v003 --omnipath /data4/paper/2013EoR/Analysis/ProcessedData/epoch1/omni_v5_xtalk/ --ex_bls='29_81' --ba ${BADANTS_S1E1} ${f:29:28}F
        # Omni Apply
        ~/capo/omni/omni_apply.py -p ${POL} --omnipath /data4/paper/2013EoR/Analysis/ProcessedData/epoch1/omni_v5_xtalk/%s.npz --xtalk --ubls="0,3;0,2;0,1;-1,1;1,1;1,2;-1,2" --ba ${BADANTS_S1E1} ${f:29:28}F 
    ...
    if (( ${f:33:7} > 2456678 )); then
        ...
        # Firstcal
        ~/capo/omni/omni_apply.py -p ${POL} --firstcal --fcfile ${FIRSTCAL_S1E2} --ba ${BADANTS_S1E2} ${f}
        # Omni Run
        ~/capo/omni/omni_run.py -p ${POL} -C psa6622_v003 --omnipath /data4/paper/2013EoR/Analysis/ProcessedData/epoch2/omni_v5_xtalk/ --ex_bls="29_81" --ba ${BADANTS_S1E2} ${f:29:28}F
        # Omni Apply
    ...
    if (( ${f:26:7} > 2456881 && ${f:26:7} < 2456929 )); then
        ...
        # Omni Run
        ~/capo/omni/omni_run.py -p ${POL} -C psa6622_v003 --omnipath /data4/paper/2014EoR/Analysis/ProcessedData/epoch3/omni_v5_xtalk/ --ba ${BADANTS_S2E3} ${f:34:28}F
        # Omni Apply
        ~/capo/omni/omni_apply.py -p ${POL} --omnipath /data4/paper/2014EoR/Analysis/ProcessedData/epoch3/omni_v5_xtalk/%s.npz --xtalk --ubls="0,3;0,2;0,1;-1,1;1,1;1,2;-1,2" --ba ${BADANTS_S2E3} ${f:34:28}F
        echo deleting ${f:34:28}F
        rm -r ${f:34:28}F
    fi
    :' 
