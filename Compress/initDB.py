...
pdb['history'].addcol('log', 'txt')
pdb['history'].addcol('exit_status','int')
pdb['history'].addcol('basefile','string')

pdb.addtab('observations')
pdb['observations'].addcol('JD','float')
pdb['observations'].addcol('pol','string')
pdb['observations'].addcol('basefile','string','pk')
...
pdb.addtab('orders')
pdb['orders'].addcol('basefile', 'string', 'pk')
