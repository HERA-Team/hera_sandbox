...
print "Max sigloss factor at {2:.2e} z={0:.2f}:  {1:.2f}".format(z_bin,n.max(sig_factors),n.max(n.where(kpls> .18, pks+errs,0)))
print "sigloss factor at 3.8e6 z={0:.2f}:  {1:.2f}".format(z_bin,float(sig_factor_interp(2*3.8e6)))
