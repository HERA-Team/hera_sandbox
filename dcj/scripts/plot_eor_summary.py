...
published = [eor_results.GMRT_2014_all,
             eor_results.MWA_32T_all,
...
fig = eor_results.plot_lowest_limits(files=sys.argv[1:],title='Kolopanis et al',
                published=published,krange=(0.1,0.4))
