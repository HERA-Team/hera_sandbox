...
a.scripting.add_standard_options(o, cal=True,chan=True,pol=True,src=True,ant=True)
...
#            axis=0)
#        print i,j,d[:10],d[-10:],n.abs((n.ma.average(d[:10])+n.ma.average(d[-10:]))/2)
        plot_x[i,j] += n.abs((n.ma.average(d[:10])+n.ma.average(d[-10:]))/2)
del(uv)
