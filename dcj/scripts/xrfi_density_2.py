...
day = int(t-2455000)
fig2.savefig('rfi_total_contamination_'+str(day)+'.png')
file = open('all_total_flags.dat','rw')
all_total_flags = pkl.load(file)
all_total_flags[day]=total_flags
file.close()
file = open('all_total_flags.dat','w')
pkl.dump(all_total_flags,file)
