#! /usr/bin/env python
import aipy as a, numpy as n, capo, pylab as P,optparse,os
import sys
"""
...
o.add_option('--nfiles',type='int',default=1,
    help='Number of files over which to average [default=1]')
...
for filename in args:
    ...
    for sep in seps:
        ...
        for bl in bls[sep]:
            ...
            g,tau,info = capo.arp.redundant_bl_cal(d[cbl],w[cbl],d[bl],w[bl],fqs,use_offset=False)
    ...
    print n.around(C,2)
    #ROWS,COLS = n.indices(C.shape)
    #print n.around(C,2) - (COLS*C[0,1] + ROWS*C[1,0])
