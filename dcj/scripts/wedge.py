...
for uvfile in sys.argv[1:]:
    ...
    P       =   n.zeros((len(bl_lengths),Nfreqs,Npol))
    P_res   =   n.zeros((len(bl_lengths),Nfreqs,Npol))
    P2      =   n.zeros((len(bl_lengths),Nfreqs,Npol)) #this accumulates the square
    P2_res  =   n.zeros((len(bl_lengths),Nfreqs,Npol))
