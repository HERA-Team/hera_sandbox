...
for file in args:
    ...
    hdu = hdulist[0]
    history ="""fix_dcj_fits_v2.py: Trying to account for transpose
    without actually untransposing."""
...
#    hdu.header['CRPIX3'] = 1
#    hdu.header['CDELT1'] = -1 * n.abs(hdu.header['CDELT1'])
##    hdu.header['CRVAL3'] *= 1e9
##    hdu.header['CDELT3'] *= 1e9
#    hdu.header.update('EPOCH',2000.0,'Epoch of coordinate system')
    hdu.header.update('TRANSPOS',0,'for AIPY backwards compatibility')
