...
p.subplot(121); C.arp.waterfall(d, mode='log'); p.colorbar(shrink=.5)
p.subplot(122); C.arp.waterfall(d, mode='phs'); p.colorbar(shrink=.5)
#p.subplot(133); C.arp.waterfall(w); p.colorbar(shrink=.5)
p.show()
