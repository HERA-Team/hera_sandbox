...
echo cov_src26.py -C pgb015_v005 -s ${SRCS0}/${SRCS0},${SRCS1}/${SRCS1},${SRCS2}/${SRCS2},${SRCS3} -b Sun -c 240_720_4 -x 4 -a cross,-1,-7,-13,-15 -p yy -r 15 -d 15 --maxiter=1000 $ARGS
cov_src26.py -C pgb015_v005 -s ${SRCS0}/${SRCS0},${SRCS1}/${SRCS1},${SRCS2}/${SRCS2},${SRCS3} -b Sun -c 240_720_4 -x 4 -a cross,-1,-7,-13,-15 -p yy -r 15 -d 15 --maxiter=1000 $ARGS
