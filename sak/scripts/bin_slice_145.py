...
for filename in args:#sys.argv[1:]: #loop through files
	...
	#JDs that consistently exceed the rms=0.03 bound for EPOCH2:
	if jd in [2456924]: continue
	#EPOCH2 residual flagging
	if jd in [2456881,2456882,2456884,2456885,2456917]: continue
	
	
	#JDs that consistently exceed the rms=0.03 bound for EPOCH3:
	if jd in [2456958, 2456964, 2456973, 2456984]: continue
	#EPOCH3i residual flagging
	if jd in [2456970]: continue
	#EPOCH3ii residual flagging
	if jd in [2457053, 2457066]: continue
