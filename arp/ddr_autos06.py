...
for filename in args:
    ...
    for (crd,t,(i,j)),d,f in uv.all(raw=True):
        ...
        #d /= 5000
        #if n.average(v[550:650]) > .5:
        if n.average(v) > .5:
            #d /= n.abs(n.median(d[550:650].compress(v[550:650]))).clip(1e-3,n.Inf)
            #d /= n.abs(n.median((d / bandpass.clip(1e-2,n.Inf)).compress(v))).clip(1e-3,n.Inf)
            #d /= 390
            #d /= 13.5
            #d -= bandpass
            pass
            ...
            d *= 0
            v *= 0
        #import pylab; pylab.plot(n.abs(d)); pylab.show()
    ...
    for bl in msrdat:
        ...
        x = chan.compress(valid)
        #poly = n.polyfit(x, n.log10(avg_spec), deg=10)
        poly = n.polyfit(x, n.log10(avg_spec), deg=1)
        _bandpass = 10**n.polyval(poly, chan)
