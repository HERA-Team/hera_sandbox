...
for boot in xrange(opts.nboot):
    ...
    if NOISE > 0:
            ...
            for k in days:
                ...
                tmp_nx[k] = {}
                for bl in x[k]:
                    noise1 = noise(_Inx[days[0]][bls_master[0]].shape)*6.6408 * NOISE ### mk 
                    for coutnt, ch in enumerate(band_chans[index]):
                        noise1[coutnt] = n.convolve(noise1[coutnt], firs[coutnt], mode='same')
