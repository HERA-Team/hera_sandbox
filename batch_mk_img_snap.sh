...
echo "~/bin/mk_img.py -a cross,-24 --minuv=20 --altmin=30 --snap=${SNAP} -s zen --size=400 --res=0.4 -pxx -C psa455_v003_gc --fmt=${FILE}_%s_%04d $FILE"
~/bin/mk_img.py -a cross,-24 --minuv=20 --altmin=30 -s zen --snap=${SNAP} --size=400 --res=0.4 -pxx -C psa455_v003_gc --fmt=${FILE}_%s_%04d $FILE